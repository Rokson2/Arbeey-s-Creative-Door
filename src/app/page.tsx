...
function HomeContent() {
  ...
  const handleGenerate = () => {
    ...
    if (requiresReferenceImage && !referenceImage) {
      setError(`Reference image is required for ${CATEGORY_LABELS[category]}`);
      return;
    }
  ...
  const isGenerateDisabled =
    ...
    !apiKey.trim() ||
    isOverLimit ||
    (requiresReferenceImage && !referenceImage);
              ...
              <div className="space-y-2">
                  ...
                  {referenceImagePreview ? (
                    <div className="relative p-4">
                      ...
                      <button
                        ...
                        className="absolute right-2 top-2 rounded-full bg-zinc-800 p-2 text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-100"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    disabled={!!referenceImagePreview}
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                  ...
                  <button
                    ...
                    disabled={!!referenceImagePreview}
                    className="rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-100 disabled:opacity-50"
                  >
                    Load
                  </button>
                </div>
